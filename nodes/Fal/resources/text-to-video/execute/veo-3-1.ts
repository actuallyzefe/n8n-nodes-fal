...
/**
 * Execute Google Veo 3.1 text-to-video generation
 *
 * Google's Veo 3.1 model for high-quality video generation with advanced features
 * like prompt enhancement and auto-fix capabilities.
 */
export async function executeVeo31(
	context: IExecuteFunctions,
	itemIndex: number,
): Promise<IDataObject> {
	// Get model configuration
	const modelConfig = getModelConfig(TEXT_TO_VIDEO_MODEL_IDS.VEO_3_1);
