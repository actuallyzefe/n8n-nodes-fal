...
/**
 * Execute Sora 2 Pro image-to-video generation
 *
 * Sora 2 Pro offers higher quality with 1080p resolution support and auto aspect ratio detection
 */
export async function executeSora2Pro(
	...
	const modelConfig = getModelConfig(IMAGE_TO_VIDEO_MODEL_IDS.SORA_2_PRO);
	...
	const duration = context.getNodeParameter('durationSora', itemIndex, '4') as string;
	const resolution = context.getNodeParameter('resolution', itemIndex, 'auto') as string;
