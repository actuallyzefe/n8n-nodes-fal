...
/**
 * Execute Google Veo 3.1 Fast First-Last Frame to Video generation
 *
 * This model animates between a first and last frame using Google's Veo 3.1 Fast model.
 */
export async function executeVeo31FastFirstLastFrame(
	context: IExecuteFunctions,
	itemIndex: number,
): Promise<IDataObject> {
	// Get model configuration
	const modelConfig = getModelConfig(IMAGE_TO_VIDEO_MODEL_IDS.VEO_3_1_FAST_FIRST_LAST_FRAME);
