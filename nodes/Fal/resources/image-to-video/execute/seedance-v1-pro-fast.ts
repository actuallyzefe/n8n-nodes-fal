...
/**
 * Execute Seedance 1.0 Pro Fast image-to-video generation
 *
 * Seedance is Bytedance's fast and efficient image-to-video model
 * Supports auto aspect ratio detection, multiple resolutions (480p-1080p), and durations (3-12 seconds)
 */
export async function executeSeedanceV1ProFast(
	...
	const modelConfig = getModelConfig(IMAGE_TO_VIDEO_MODEL_IDS.SEEDANCE_V1_PRO_FAST);
	...
	const duration = context.getNodeParameter('durationSeedance', itemIndex, '5') as string;
